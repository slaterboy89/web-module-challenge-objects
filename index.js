...
console.log(createMenuItem('Breakfast Platter', 10, 'Lunch'));
console.log(createMenuItem('Pizza', 7, 'Lunch'));
console.log(createMenuItem('Sweet Tea', 2, 'Lunch'));
...
reviews[8] = {name: 'LJ', rating: 5, feedback: 'Best food in town!'};
console.log(reviews);
